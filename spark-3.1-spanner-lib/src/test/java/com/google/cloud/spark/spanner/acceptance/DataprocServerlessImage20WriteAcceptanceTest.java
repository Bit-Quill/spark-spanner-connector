...
public final class DataprocServerlessImage20WriteAcceptanceTest
    extends DataprocServerlessWriteAcceptanceTestBase {

  private static AcceptanceTestContext context;
  public static final String CONNECTOR_JAR_DIRECTORY = "../spark-3.1-spanner/target";

  public DataprocServerlessImage20WriteAcceptanceTest() {
