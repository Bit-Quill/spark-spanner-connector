...
INSERT INTO
    CUSTOMER( C_CUSTKEY,
              ...
              C_COMMENT)
    VALUES
        (36901, "Customer#000036901", "TBb1yDZcf 8Zepk7apFJ", 13, "23-644-998-4944", 4809.84, "AUTOMOBILE", "com.google.cloud.spanner.SpannerExceptionFactory.newSpannerException"),
        (78002, "Customer#000078002","v7Jkg5XIq", 10, "20-715-308-7926", 4128.41,"AUTOMOBILE", "ly after the special deposits. careful packages"),
        (123314, "Customer#000123314", "nKPmaZi,OKhObOYSL3wc egXR4Vt99CXRclF",15,"25-884-345-1592",-686.40, "MACHINERY", "ounts serve furiously. carefully expre");
...
INSERT INTO
    LINEITEM(
            ...
            L_COMMENT)
VALUES
(36901,1,155190,7706,1,17,21168.23,0.04,0.02,"N","O",DATE("1996-03-13"),DATE("1996-02-12"),DATE("1996-03-22"),"DELIVER IN PERSON","TRUCK","egular courts above the"),
(36901,1,67310,7311,2,36,45983.16,0.09,0.06,"N","O",DATE("1996-04-12"),DATE("1996-02-28"),DATE("1996-04-20"),"TAKE BACK RETURN","MAIL","ly final dependencies: slyly bold "),
(36901,1,63700,3701,3,8,13309.60,0.10,0.02,"N","O",DATE("1996-01-29"),DATE("1996-03-05"),DATE("1996-01-31"),"TAKE BACK RETURN","REG AIR","riously. regular, express dep"),
(36901,1,2132,4633,4,28,28955.64,0.09,0.06,"N","O",DATE("1996-04-21"),DATE("1996-03-30"),DATE("1996-05-16"),"NONE","AIR","lites. fluffily even de"),
(36901,1,24027,1534,5,24,22824.48,0.10,0.04,"N","O",DATE("1996-03-30"),DATE("1996-03-14"),DATE("1996-04-01"),"NONE","FOB", "pending foxes. slyly re"),
(36901,1,15635,638,6,32,49620.16,0.07,0.02,"N","O",DATE("1996-01-30"),DATE("1996-02-07"),DATE("1996-02-03"),"DELIVER IN PERSON","MAIL","arefully slyly ex"),
(78002,2,106170,1191,1,38,44694.46,0.00,0.05,"N","O",DATE("1997-01-28"),DATE("1997-01-14"),DATE("1997-02-02"),"TAKE BACK RETURN","RAIL","ven requests. deposits breach a"),
(123314,3,4297,1798,1,45,54058.05,0.06,0.00,"R","F",DATE("1994-02-02"),DATE("1994-01-04"),DATE("1994-02-23"),"NONE","AIR","ongside of the furiously brave acco"),
(123314,3,19036,6540,2,49,46796.47,0.10,0.00,"R","F",DATE("1993-11-09"),DATE("1993-12-20"),DATE("1993-11-24"),"TAKE BACK RETURN","RAIL", "unusual accounts. eve"),
(123314,3,128449,3474,3,27,39890.88,0.06,0.07,"A","F",DATE("1994-01-16"),DATE("1993-11-22"),DATE("1994-01-23"),"DELIVER IN PERSON","SHIP","nal foxes wake."),
(123314,3,29380,1883,4,2,2618.76,0.01,0.06,"A","F",DATE("1993-12-04"),DATE("1994-01-07"),DATE("1994-01-01"),"NONE","TRUCK","y. fluffily pending d"),
(123314,3,183095,650,5,28,32986.52,0.04,0.00,"R","F",DATE("1993-12-14"),DATE("1994-01-10"),DATE("1994-01-01"),"TAKE BACK RETURN","FOB","ages nag slyly pending"),
(123314,3,62143,9662,6,26,28733.64,0.10,0.02,"A","F",DATE("1993-10-29"),DATE("1993-12-18"),DATE("1993-11-04"),"TAKE BACK RETURN","RAIL","ges sleep after the caref");
